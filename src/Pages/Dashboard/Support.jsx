...
import { useCreateSupportMutation, useSupportQuery, useUpdateSupportMutation } from '../../redux/apiSlices/settingSlices';
...
const Support = () => {
    ...
    const handleSubmit = async () => {
        ...
        if (supportContents?._id) {
            await updateSupport(data).then((res) => {
                if (res?.data?.success) {
                    Swal.fire({
